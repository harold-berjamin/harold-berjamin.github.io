...
The effect of a large static pre-deformation is analysed in a recent publication [link](/publication/2022-02-26-ijss). Application of this acoustoelasticity theory to pre-stressed phononic crystals was also considered (Figure). Computations show that dissipation shifts the band gaps (i.e., the frequency range in which waves cannot propagate), simultaneously increasing their width.

The formation of shock waves is analysed in a recent publication [link](/publication/2022-02-02-wamot). Ongoing works concern nonlinear waves, experimental validations, and computer implementations.
